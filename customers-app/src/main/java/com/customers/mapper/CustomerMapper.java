...
public interface CustomerMapper {
  ...
  @Mapping(target = "dateOfBirth", source = "person.dateOfBirth") Customer fromCreateBodyToEntity(CreateCustomerRequestDTO createCustomerRequestDTO);

  @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
  @Mapping(target = "name", source = "person.name")
  @Mapping(target = "firstName", source = "person.firstName")
  @Mapping(target = "dateOfBirth", source = "person.dateOfBirth") Customer updateEntityFromModel(UpdateCustomerRequestDTO dto,
      @MappingTarget Customer entity);

  @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
  @Mapping(target = "name", source = "person.name")
  @Mapping(target = "firstName", source = "person.firstName")
  @Mapping(target = "dateOfBirth", source = "person.dateOfBirth") Customer updateEntityFromModel(CustomerDTO dto,
      @MappingTarget Customer entity);
